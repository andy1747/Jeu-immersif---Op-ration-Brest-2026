...
const GAME_DATA = {
  ...
  challengeBank: {
    ...
    // autres défis, affichés en permanence dès le chapitre 2 dans un
    // bloc à part (pas de bouton "Passer" : on ne les tire pas au sort,
    // toute l'équipe les voit et les valide toutes au fil de la soirée).
    //
