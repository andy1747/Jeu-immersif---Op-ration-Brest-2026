...
function renderDormantsTab(c){
  ...
  c.innerHTML = `
    ...
    <div class="card" style="border-color:var(--accent);">
      <h3>🔐 Coffre IPC — code final</h3>
      <p class="dim">Code complet à reconstituer (les équipes n'en voient jamais que leur fragment) : <b style="letter-spacing:3px;">${GAME_DATA.coffreCode}</b></p>
      <p class="dim">${CONFIG_CACHE.coffreOpened ? "✅ Coffre déjà ouvert." : "En attente que les 5 équipes terminent leur Quiz IPC, puis saisissent le code réuni."}</p>
